...
var Struct = function (_Component) {
  ...
  Struct.prototype.addToCollection = function addToCollection(key) {
    ...
    var data = (0, _lodash.cloneDeep)(this.state.struct[key]);
    var s = struct;
    console.log(s, key, (0, _lodash.has)(s, key), data);
    if ((0, _lodash.has)(s, key) && (0, _lodash.has)(s[key], 'type') && (s[key].type === 'KeyValue' || s[key].type === 'Object')) {
      ...
      var _s = _s.struct;
      if ((0, _lodash.has)(_s, key) && (0, _lodash.has)(_s[key], 'type') && (_s[key].type === 'KeyValue' || _s[key].type === 'Object')) {
        data[''] = undefined;
      } else if ((0, _lodash.has)(_s, key) && (0, _lodash.has)(_s[key], 'type') && _s[key].type === 'Array') {
        data.push(_s[key].struct["default"]);
      } else if ((0, _lodash.has)(_s, key) && (0, _lodash.has)(_s[key], 'type')) {
        data.push((0, _defaultFromStruct2["default"])(_s[key].struct));
      } else {
        data.push((0, _defaultFromStruct2["default"])(_s[key].struct));
      }
    }
